...
map = L.map('map').setView([40.65,-73.93], 12);
CartoDBTiles = L.tileLayer('http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png',
	{
  		attribution: 'Map Data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> Contributors, Map Tiles &copy; <a href="http://cartodb.com/attributions">CartoDB</a>'
	}
);
apiLayerGroup = L.layerGroup();
...
acsStyle = function (feature, latlng) {
...
acsOnEachFeature = function(feature,layer){
	var calc = calculatePercentage(feature);
...
function setUpD3Scale(dataset) {
	...
	var ordinalScale = d3.scale.category20().domain(descriptorsUnique);
    return ordinalScale;
}
